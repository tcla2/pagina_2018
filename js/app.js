...
function submitAction(event){
  ...
  var url = "http://gateway.marvel.com/v1/public/characters?ts=3&apikey=dc83044172250ca6f026770448fe243c&hash=41a112fe356d13b3040106b89c671c56";
...
function appendHTML(response){
  ...
  $.each(response.data.results[0].events.items, function(index, value){s
